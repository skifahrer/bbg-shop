 ...
 */
final class Version20241108155528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE checkout (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', cart_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', order_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL, shipping_address VARCHAR(255) DEFAULT NULL, invoice_address VARCHAR(255) DEFAULT NULL, payment_type VARCHAR(255) DEFAULT NULL, INDEX IDX_AF382D4EA76ED395 (user_id), UNIQUE INDEX UNIQ_AF382D4E1AD5CDBF (cart_id), UNIQUE INDEX UNIQ_AF382D4E8D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', item VARCHAR(255) NOT NULL, oxprice NUMERIC(10, 2) NOT NULL, weight NUMERIC(10, 2) NOT NULL, stock INT NOT NULL, length INT NOT NULL, width INT NOT NULL, height INT NOT NULL, title_en VARCHAR(255) NOT NULL, title_sk VARCHAR(255) NOT NULL, title_sl VARCHAR(255) NOT NULL, title_hu VARCHAR(255) NOT NULL, title_hr VARCHAR(255) NOT NULL, title_ro VARCHAR(255) NOT NULL, title_bg VARCHAR(255) NOT NULL, features_json JSON NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_D34A04AD1F1B251E (item), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `shop_order` (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL, final_price NUMERIC(10, 2) NOT NULL, shipping_address VARCHAR(255) NOT NULL, invoice_address VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_323FC9CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(180) NOT NULL, family VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, shipping_address VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX idx_user_email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE checkout ADD CONSTRAINT FK_AF382D4E8D9F6D38 FOREIGN KEY (order_id) REFERENCES `shop_order` (id)');
        $this->addSql('ALTER TABLE item_quantity ADD CONSTRAINT FK_F3FEDEFD1AD5CDBF FOREIGN KEY (cart_id) REFERENCES cart (id)');
        $this->addSql('ALTER TABLE item_quantity ADD CONSTRAINT FK_F3FEDEFD8D9F6D38 FOREIGN KEY (order_id) REFERENCES `shop_order` (id)');
